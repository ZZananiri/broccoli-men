...
/**
 * Filter strategy class for filtering employee data by gender
 */
public class GenderFilterStrategy implements FilterStrategy{
    /**
    ...
    public boolean filterEmployees(Employee employee, String lowerCaseFilter) {
        return employee.getGender().toLowerCase().startsWith(lowerCaseFilter);
    }
