...
/**
 * Filter strategy class for filtering employee data by employee id
 */
public class IdFilterStrategy implements FilterStrategy{
    /**
    ...
    public boolean filterEmployees(Employee employee, String lowerCaseFilter) {
        return ((Integer) employee.getEmployeeID()).toString().startsWith(lowerCaseFilter);
    }
