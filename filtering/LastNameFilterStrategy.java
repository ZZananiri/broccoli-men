...
/**
 * Filter strategy class for filtering employee data by last name
 */
public class LastNameFilterStrategy implements FilterStrategy{
    /**
    ...
    public boolean filterEmployees(Employee employee, String lowerCaseFilter) {
        return employee.getLastName().toLowerCase().startsWith(lowerCaseFilter);
    }
